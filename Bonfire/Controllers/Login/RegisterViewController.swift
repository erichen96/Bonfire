...
class RegisterViewController: UIViewController {
    ...
    @objc private func registerButtonTapped() {
        ...
        FirebaseAuth.Auth.auth().createUser(withEmail: email, password: password, completion: { [weak self] authResult, error in
            ...
            let bonfireUser = BonfireUser(firstName: firstName,
                                          lastName: lastName,
                                          emailAddress: email)
...
// When user enters in their information to the text fields, if they press enter on the keyboard move user interaction to next required field.
...
extension RegisterViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func presentPhotoActionSheet(){
        let actionSheet = UIAlertController(title: "Profile Picture",
                                            message: "How would you like to select image",
    ...
    // Allows users to take a picture using their camera, currently will crash the app
    func presentCamera() {
